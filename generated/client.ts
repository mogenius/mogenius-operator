...
export enum Pattern {
  ...
  AIMANAGER_READ_TASK = "aiManager/read/task",
  AIMANAGER_RESET_DAILY_TOKEN_LIMIT = "aiManager/reset-daily-token-limit",
  AIMANAGER_STATUS = "aiManager/status",
  AIMANAGER_UPDATE_FILTER_STATES = "aiManager/update-filter-states",
  AIMANAGER_UPDATE_TASK = "aiManager/update/task",
  ALERTMANAGER_ALERTS_CREATE = "alertmanager/alerts/create",
  ALERTMANAGER_ALERTS_LIST = "alertmanager/alerts/list",
  ALERTMANAGER_SILENCES_CREATE = "alertmanager/silences/create",
  ...
  LIVE_STREAM_AI_MANAGER_CHAT_REQUEST = "live-stream/ai-manager-chat-request",
...
export const StringToPattern = {
  ...
  "aiManager/read/task": Pattern.AIMANAGER_READ_TASK,
  "aiManager/reset-daily-token-limit": Pattern.AIMANAGER_RESET_DAILY_TOKEN_LIMIT,
  "aiManager/status": Pattern.AIMANAGER_STATUS,
  "aiManager/update-filter-states": Pattern.AIMANAGER_UPDATE_FILTER_STATES,
  "aiManager/update/task": Pattern.AIMANAGER_UPDATE_TASK,
  "alertmanager/alerts/create": Pattern.ALERTMANAGER_ALERTS_CREATE,
  "alertmanager/alerts/list": Pattern.ALERTMANAGER_ALERTS_LIST,
  "alertmanager/silences/create": Pattern.ALERTMANAGER_SILENCES_CREATE,
  ...
  "live-stream/ai-manager-chat-request": Pattern.LIVE_STREAM_AI_MANAGER_CHAT_REQUEST,
...
export const PatternToString = {
  ...
  [Pattern.AIMANAGER_READ_TASK]: "aiManager/read/task",
  [Pattern.AIMANAGER_RESET_DAILY_TOKEN_LIMIT]: "aiManager/reset-daily-token-limit",
  [Pattern.AIMANAGER_STATUS]: "aiManager/status",
  [Pattern.AIMANAGER_UPDATE_FILTER_STATES]: "aiManager/update-filter-states",
  [Pattern.AIMANAGER_UPDATE_TASK]: "aiManager/update/task",
  [Pattern.ALERTMANAGER_ALERTS_CREATE]: "alertmanager/alerts/create",
  [Pattern.ALERTMANAGER_ALERTS_LIST]: "alertmanager/alerts/list",
  [Pattern.ALERTMANAGER_SILENCES_CREATE]: "alertmanager/silences/create",
  ...
  [Pattern.LIVE_STREAM_AI_MANAGER_CHAT_REQUEST]: "live-stream/ai-manager-chat-request",
 ...
 *
 */
export type AIMANAGER_GET_TASKS_REQUEST = AIMANAGER_GET_TASKS_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST;
 ...
 *           type: string
 *         type: array
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·42,[]mogenius-operator/src/ai.AiTask]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·42,[]mogenius-operator/src/ai.AiTask]
 *     properties:
 *       data:
 *         elementType:
 *           structRef: mogenius-operator/src/ai.AiTask
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·42,[]mogenius-operator/src/ai.AiTask]
 *   type: struct
 * ```
 *
 */
export type AIMANAGER_GET_TASKS_RESPONSE = AIMANAGER_GET_TASKS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST42_MOGENIUS_OPERATOR_SRC_AI_AITASK;
 ...
 *           type: struct
 *         type: array
 *   mogenius-operator/src/ai.AiPrompts:
 *     name: mogenius-operator/src/ai.AiPrompts
 *     properties:
 *       chatSystemPrompt:
 *         type: string
 *       gitMemoryRepositorySystemPrompt:
 *         type: string
 *       githubSystemPrompt:
 *         type: string
 *   mogenius-operator/src/core.Request:
 ...
 *         type: struct
 *       aiPrompts:
 *         structRef: mogenius-operator/src/ai.AiPrompts
 *         type: struct
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Request
 *   type: struct
 ...
 *
 */
export type AIMANAGER_INJECT_PROMPT_CONFIG_REQUEST = AIMANAGER_INJECT_PROMPT_CONFIG_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST;
 ...
 *   ANON_STRUCT_1:
 *     properties: {}
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·39,mogenius-operator/src/core.Void]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·39,mogenius-operator/src/core.Void]
 *     properties:
 *       data:
 *         pointer: true
 *         structRef: ANON_STRUCT_1
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·39,mogenius-operator/src/core.Void]
 *   type: struct
 * ```
 *
 */
export type AIMANAGER_INJECT_PROMPT_CONFIG_RESPONSE = AIMANAGER_INJECT_PROMPT_CONFIG_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST39_MOGENIUS_OPERATOR_SRC_CORE_VOID;
 ...
 *
 */
export type AIMANAGER_LATEST_TASK_REQUEST = AIMANAGER_LATEST_TASK_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST;
 ...
 *           type: string
 *         type: array
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·45,*mogenius-operator/src/ai.AiTaskLatest]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·45,*mogenius-operator/src/ai.AiTaskLatest]
 *     properties:
 *       data:
 *         pointer: true
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·45,*mogenius-operator/src/ai.AiTaskLatest]
 *   type: struct
 * ```
 *
 */
export type AIMANAGER_LATEST_TASK_RESPONSE = AIMANAGER_LATEST_TASK_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST45_MOGENIUS_OPERATOR_SRC_AI_AITASKLATEST;
 ...
 *
 */
export type AIMANAGER_READ_TASK_REQUEST = AIMANAGER_READ_TASK_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST;
 ...
 *
 */
export type AIMANAGER_READ_TASK_RESPONSE = AIMANAGER_READ_TASK_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST43_MOGENIUS_OPERATOR_SRC_CORE_VOID;
 ...
 *
 */
export type AIMANAGER_RESET_DAILY_TOKEN_LIMIT_REQUEST = AIMANAGER_RESET_DAILY_TOKEN_LIMIT_REQUEST__ANON_STRUCT_0|undefined;
 ...
 *
 */
export type AIMANAGER_RESET_DAILY_TOKEN_LIMIT_RESPONSE = AIMANAGER_RESET_DAILY_TOKEN_LIMIT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_VOID;
 ...
 *
 */
export type AIMANAGER_STATUS_REQUEST = AIMANAGER_STATUS_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST;
 ...
 *       warning:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·41,mogenius-operator/src/ai.AiManagerStatus]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·41,mogenius-operator/src/ai.AiManagerStatus]
 *     properties:
 *       data:
 *         structRef: mogenius-operator/src/ai.AiManagerStatus
 *         type: struct
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·41,mogenius-operator/src/ai.AiManagerStatus]
 *   type: struct
 * ```
 *
 */
export type AIMANAGER_STATUS_RESPONSE = AIMANAGER_STATUS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST41_MOGENIUS_OPERATOR_SRC_AI_AIMANAGERSTATUS;
 ...
 *       prompt:
 *         type: string
 *   mogenius-operator/src/core.UpdateFiltersRequest:
 *     name: mogenius-operator/src/core.UpdateFiltersRequest
 *     properties:
 *       filters:
 *         elementType:
 *           structRef: mogenius-operator/src/ai.AiFilter
 ...
 *         type: array
 * typeInfo:
 *   structRef: mogenius-operator/src/core.UpdateFiltersRequest
 *   type: struct
 * ```
 *
 */
export type AIMANAGER_UPDATE_FILTER_STATES_REQUEST = AIMANAGER_UPDATE_FILTER_STATES_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_UPDATEFILTERSREQUEST;
 ...
 *   ANON_STRUCT_1:
 *     properties: {}
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.UpdateFiltersRequest·40,mogenius-operator/src/core.Void]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.UpdateFiltersRequest·40,mogenius-operator/src/core.Void]
 *     properties:
 *       data:
 *         pointer: true
 *         structRef: ANON_STRUCT_1
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.UpdateFiltersRequest·40,mogenius-operator/src/core.Void]
 *   type: struct
 * ```
 *
 */
export type AIMANAGER_UPDATE_FILTER_STATES_RESPONSE = AIMANAGER_UPDATE_FILTER_STATES_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_UPDATEFILTERSREQUEST40_MOGENIUS_OPERATOR_SRC_CORE_VOID;
 ...
 *
 */
export type AIMANAGER_UPDATE_TASK_REQUEST = AIMANAGER_UPDATE_TASK_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST;
 ...
 *   ANON_STRUCT_1:
 *     properties: {}
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·44,mogenius-operator/src/core.Void]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·44,mogenius-operator/src/core.Void]
 *     properties:
 *       data:
 *         pointer: true
 *         structRef: ANON_STRUCT_1
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·44,mogenius-operator/src/core.Void]
 *   type: struct
 * ```
 *
 */
export type AIMANAGER_UPDATE_TASK_RESPONSE = AIMANAGER_UPDATE_TASK_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST44_MOGENIUS_OPERATOR_SRC_CORE_VOID;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.SendAlertRequest:
 *     name: mogenius-operator/src/core.SendAlertRequest
 *     properties:
 *       annotations:
 *         keyType:
 *           type: string
 ...
 * typeInfo:
 *   elementType:
 *     structRef: mogenius-operator/src/core.SendAlertRequest
 *     type: struct
 *   type: array
 * ```
 *
 */
export type ALERTMANAGER_ALERTS_CREATE_REQUEST = ALERTMANAGER_ALERTS_CREATE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_SENDALERTREQUEST[];
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[[]mogenius-operator/src/core.SendAlertRequest,string]:
 *     name: mogenius-operator/src/core.Result[[]mogenius-operator/src/core.SendAlertRequest,string]
 *     properties:
 *       data:
 *         type: string
 *       message:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[[]mogenius-operator/src/core.SendAlertRequest,string]
 *   type: struct
 * ```
 *
 */
export type ALERTMANAGER_ALERTS_CREATE_RESPONSE = ALERTMANAGER_ALERTS_CREATE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_SENDALERTREQUEST_STRING;
 ...
 *
 */
export type ALERTMANAGER_ALERTS_LIST_REQUEST = ALERTMANAGER_ALERTS_LIST_REQUEST__ANON_STRUCT_0|undefined;
 ...
 *       Name:
 *         type: string
 *   mogenius-operator/src/core.Alert:
 *     name: mogenius-operator/src/core.Alert
 *     properties:
 *       annotations:
 *         keyType:
 *           type: string
 ...
 *         type: struct
 *       status:
 *         structRef: mogenius-operator/src/core.AlertStatus
 *         type: struct
 *       updatedAt:
 *         structRef: time.Time
 *         type: struct
 *   mogenius-operator/src/core.AlertStatus:
 *     name: mogenius-operator/src/core.AlertStatus
 *     properties:
 *       inhibitedBy:
 *         elementType:
 *           type: string
 ...
 *       state:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,[]mogenius-operator/src/core.Alert]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,[]mogenius-operator/src/core.Alert]
 *     properties:
 *       data:
 *         elementType:
 *           structRef: mogenius-operator/src/core.Alert
 *           type: struct
 *         type: array
 *       message:
 *         type: string
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,[]mogenius-operator/src/core.Alert]
 *   type: struct
 * ```
 *
 */
export type ALERTMANAGER_ALERTS_LIST_RESPONSE = ALERTMANAGER_ALERTS_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_ALERT;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.AlertMatcher:
 *     name: mogenius-operator/src/core.AlertMatcher
 *     properties:
 *       isEqual:
 *         type: bool
 *       isRegex:
 ...
 *       value:
 *         type: string
 *   mogenius-operator/src/core.SilenceRequest:
 *     name: mogenius-operator/src/core.SilenceRequest
 *     properties:
 *       comment:
 *         type: string
 *       createdBy:
 ...
 *       matchers:
 *         elementType:
 *           structRef: mogenius-operator/src/core.AlertMatcher
 *           type: struct
 *         type: array
 *       startsAt:
 *         structRef: time.Time
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.SilenceRequest
 *   type: struct
 * ```
 *
 */
export type ALERTMANAGER_SILENCES_CREATE_REQUEST = ALERTMANAGER_SILENCES_CREATE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_SILENCEREQUEST;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.SilenceRequest,string]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.SilenceRequest,string]
 *     properties:
 *       data:
 *         type: string
 *       message:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.SilenceRequest,string]
 *   type: struct
 * ```
 *
 */
export type ALERTMANAGER_SILENCES_CREATE_RESPONSE = ALERTMANAGER_SILENCES_CREATE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_SILENCEREQUEST_STRING;
 ...
 *
 */
export type ALERTMANAGER_SILENCES_DELETE_REQUEST = ALERTMANAGER_SILENCES_DELETE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST;
 ...
 *
 */
export type ALERTMANAGER_SILENCES_DELETE_RESPONSE = ALERTMANAGER_SILENCES_DELETE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST17_STRING;
 ...
 *
 */
export type ALERTMANAGER_SILENCES_LIST_REQUEST = ALERTMANAGER_SILENCES_LIST_REQUEST__ANON_STRUCT_0|undefined;
 ...
 *       value:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,[]mogenius-operator/src/core.Silence]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,[]mogenius-operator/src/core.Silence]
 *     properties:
 *       data:
 *         elementType:
 *           structRef: mogenius-operator/src/core.Silence
 *           type: struct
 *         type: array
 *       message:
 *         type: string
 *       status:
 *         type: string
 *   mogenius-operator/src/core.Silence:
 *     name: mogenius-operator/src/core.Silence
 *     properties:
 *       comment:
 *         type: string
 *       createdBy:
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,[]mogenius-operator/src/core.Silence]
 *   type: struct
 * ```
 *
 */
export type ALERTMANAGER_SILENCES_LIST_RESPONSE = ALERTMANAGER_SILENCES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_SILENCE;
 ...
 *       status:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·46,mogenius-operator/src/core.Response·47]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·46,mogenius-operator/src/core.Response·47]
 *     properties:
 *       data:
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·46,mogenius-operator/src/core.Response·47]
 *   type: struct
 * ```
 *
 */
export type AUDIT_LOG_LIST_RESPONSE = AUDIT_LOG_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST46_MOGENIUS_OPERATOR_SRC_CORE_RESPONSE47;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·7,string]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·7,string]
 *     properties:
 *       data:
 *         type: string
 *       message:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·7,string]
 *   type: struct
 * ```
 *
 */
export type CLUSTER_CLEAR_VALKEY_CACHE_RESPONSE = CLUSTER_CLEAR_VALKEY_CACHE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST7_STRING;
 ...
 *
 */
export type CLUSTER_DASHBOARD_STATS_REQUEST = CLUSTER_DASHBOARD_STATS_REQUEST__ANON_STRUCT_0|undefined;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.ClusterDashboardStats:
 *     name: mogenius-operator/src/core.ClusterDashboardStats
 *     properties:
 *       cpuHistory:
 *         elementType:
 ...
 *       workspaceMetrics:
 *         elementType:
 *           structRef: mogenius-operator/src/core.WorkspaceDashboardMetrics
 *           type: struct
 *         type: array
 ...
 *       value:
 *         type: float
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.ClusterDashboardStats]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.ClusterDashboardStats]
 *     properties:
 *       data:
 *         structRef: mogenius-operator/src/core.ClusterDashboardStats
 *         type: struct
 *       message:
 *         type: string
 *       status:
 *         type: string
 *   mogenius-operator/src/core.WorkspaceDashboardMetrics:
 *     name: mogenius-operator/src/core.WorkspaceDashboardMetrics
 *     properties:
 *       cpuMillicores:
 *         type: float
 *       memoryMb:
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.ClusterDashboardStats]
 *   type: struct
 * ```
 *
 */
export type CLUSTER_DASHBOARD_STATS_RESPONSE = CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_CLUSTERDASHBOARDSTATS;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·18,[]mogenius-operator/src/structs.MachineStats]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·18,[]mogenius-operator/src/structs.MachineStats]
 *     properties:
 *       data:
 *         elementType:
 ...
 *         type: bool
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·18,[]mogenius-operator/src/structs.MachineStats]
 *   type: struct
 * ```
 *
 */
export type CLUSTER_MACHINE_STATS_RESPONSE = CLUSTER_MACHINE_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST18_MOGENIUS_OPERATOR_SRC_STRUCTS_MACHINESTATS;
 ...
 *       provider:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.ClusterResourceInfo·5]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.ClusterResourceInfo·5]
 *     properties:
 *       data:
 ...
 *         type: float
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.ClusterResourceInfo·5]
 *   type: struct
 * ```
 *
 */
export type CLUSTER_RESOURCE_INFO_RESPONSE = CLUSTER_RESOURCE_INFO_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_CLUSTERRESOURCEINFO5;
 ...
 *
 */
export type CREATE_GRANT_RESPONSE = CREATE_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST34_STRING;
 ...
 *
 */
export type CREATE_USER_RESPONSE = CREATE_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST29_STRING;
 ...
 *
 */
export type CREATE_WORKSPACE_RESPONSE = CREATE_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST23_STRING;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·37,string]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·37,string]
 *     properties:
 *       data:
 *         type: string
 *       message:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·37,string]
 *   type: struct
 * ```
 *
 */
export type DELETE_GRANT_RESPONSE = DELETE_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST37_STRING;
 ...
 *
 */
export type DELETE_USER_RESPONSE = DELETE_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST32_STRING;
 ...
 *
 */
export type DELETE_WORKSPACE_RESPONSE = DELETE_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST27_STRING;
 ...
 *           type: struct
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.Response·4]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.Response·4]
 *     properties:
 *       data:
 *         structRef: mogenius-operator/src/core.Response
 *         type: struct
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.Response·4]
 *   type: struct
 * ```
 *
 */
export type DESCRIBE_RESPONSE = DESCRIBE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_RESPONSE4;
 ...
 *
 */
export type FILES_CHMOD_RESPONSE = FILES_CHMOD_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST14_BOOL;
 ...
 *
 */
export type FILES_CHOWN_RESPONSE = FILES_CHOWN_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST13_BOOL;
 ...
 *
 */
export type FILES_CREATE_FOLDER_RESPONSE = FILES_CREATE_FOLDER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST11_BOOL;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·15,bool]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·15,bool]
 *     properties:
 *       data:
 *         type: bool
 *       message:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·15,bool]
 *   type: struct
 * ```
 *
 */
export type FILES_DELETE_RESPONSE = FILES_DELETE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST15_BOOL;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·16,mogenius-operator/src/services.FilesDownloadResponse]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·16,mogenius-operator/src/services.FilesDownloadResponse]
 *     properties:
 *       data:
 ...
 *         type: int
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·16,mogenius-operator/src/services.FilesDownloadResponse]
 *   type: struct
 * ```
 *
 */
export type FILES_DOWNLOAD_RESPONSE = FILES_DOWNLOAD_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST16_MOGENIUS_OPERATOR_SRC_SERVICES_FILESDOWNLOADRESPONSE;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·10,[]mogenius-operator/src/dtos.PersistentFileDto]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·10,[]mogenius-operator/src/dtos.PersistentFileDto]
 *     properties:
 *       data:
 *         elementType:
 *           structRef: mogenius-operator/src/dtos.PersistentFileDto
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·10,[]mogenius-operator/src/dtos.PersistentFileDto]
 *   type: struct
 * ```
 *
 */
export type FILES_LIST_RESPONSE = FILES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST10_MOGENIUS_OPERATOR_SRC_DTOS_PERSISTENTFILEDTO;
 ...
 *
 */
export type FILES_RENAME_RESPONSE = FILES_RENAME_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST12_BOOL;
 ...
 *       kind:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·35,*mogenius-operator/src/crds/v1alpha1.Grant]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·35,*mogenius-operator/src/crds/v1alpha1.Grant]
 *     properties:
 *       data:
 *         pointer: true
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·35,*mogenius-operator/src/crds/v1alpha1.Grant]
 *   type: struct
 * ```
 *
 */
export type GET_GRANT_RESPONSE = GET_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST35_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_GRANT;
 ...
 *
 */
export type GET_GRANTS_RESPONSE = GET_GRANTS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST33_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_GRANT;
 ...
 *           type: struct
 *         type: array
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.Response·50]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.Response·50]
 *     properties:
 *       data:
 *         structRef: mogenius-operator/src/core.Response
 *         type: struct
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Void,mogenius-operator/src/core.Response·50]
 *   type: struct
 * ```
 *
 */
export type GET_NODES_METRICS_RESPONSE = GET_NODES_METRICS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_RESPONSE50;
 ...
 *       kind:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·30,*mogenius-operator/src/crds/v1alpha1.User]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·30,*mogenius-operator/src/crds/v1alpha1.User]
 *     properties:
 *       data:
 *         pointer: true
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·30,*mogenius-operator/src/crds/v1alpha1.User]
 *   type: struct
 * ```
 *
 */
export type GET_USER_RESPONSE = GET_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST30_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_USER;
 ...
 *
 */
export type GET_USERS_RESPONSE = GET_USERS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST28_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_USER;
 ...
 *           type: struct
 *         type: array
 *   ? mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·19,k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.UnstructuredList]
 *   : name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·19,k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.UnstructuredList]
 *     properties:
 *       data:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·19,k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.UnstructuredList]
 *   type: struct
 * ```
 *
 */
export type GET_WORKLOAD_LIST_RESPONSE = GET_WORKLOAD_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST19_K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTUREDLIST;
 ...
 *       timestamp:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.PodEventsRequest·21,[]mogenius-operator/src/core.PodEvent·22]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.PodEventsRequest·21,[]mogenius-operator/src/core.PodEvent·22]
 *     properties:
 *       data:
 *         elementType:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.PodEventsRequest·21,[]mogenius-operator/src/core.PodEvent·22]
 *   type: struct
 * ```
 *
 */
export type GET_WORKLOAD_POD_EVENTS_RESPONSE = GET_WORKLOAD_POD_EVENTS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_PODEVENTSREQUEST21_MOGENIUS_OPERATOR_SRC_CORE_PODEVENT22;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.PodLogsRequest·20,string]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.PodLogsRequest·20,string]
 *     properties:
 *       data:
 *         type: string
 *       message:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.PodLogsRequest·20,string]
 *   type: struct
 * ```
 *
 */
export type GET_WORKLOAD_POD_LOGS_RESPONSE = GET_WORKLOAD_POD_LOGS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_PODLOGSREQUEST20_STRING;
 ...
 *           type: struct
 *         type: array
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·24,*mogenius-operator/src/core.GetWorkspaceResult]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·24,*mogenius-operator/src/core.GetWorkspaceResult]
 *     properties:
 *       data:
 *         pointer: true
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·24,*mogenius-operator/src/core.GetWorkspaceResult]
 *   type: struct
 * ```
 *
 */
export type GET_WORKSPACE_RESPONSE = GET_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST24_MOGENIUS_OPERATOR_SRC_CORE_GETWORKSPACERESULT;
 ...
 *           pointer: true
 *           type: any
 *   ? mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·38,[]k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured]
 *   : name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·38,[]k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured]
 *     properties:
 *       data:
 *         elementType:
 *           structRef: k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·38,[]k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured]
 *   type: struct
 * ```
 *
 */
export type GET_WORKSPACE_WORKLOADS_RESPONSE = GET_WORKSPACE_WORKLOADS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST38_K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTURED;
 ...
 *           pointer: true
 *           type: any
 *   ? mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·48,*k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured]
 *   : name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·48,*k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured]
 *     properties:
 *       data:
 *         pointer: true
 *         structRef: k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·48,*k8s.io/apimachinery/pkg/apis/meta/v1/unstructured.Unstructured]
 *   type: struct
 * ```
 *
 */
export type SEALED_SECRET_CREATE_FROM_EXISTING_RESPONSE = SEALED_SECRET_CREATE_FROM_EXISTING_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST48_K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTURED;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·8,*[]mogenius-operator/src/structs.PodStats]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·8,*[]mogenius-operator/src/structs.PodStats]
 *     properties:
 *       data:
 *         elementType:
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·8,*[]mogenius-operator/src/structs.PodStats]
 *   type: struct
 * ```
 *
 */
export type STATS_POD_ALL_FOR_CONTROLLER_RESPONSE = STATS_POD_ALL_FOR_CONTROLLER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST8_MOGENIUS_OPERATOR_SRC_STRUCTS_PODSTATS;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·8,*[]mogenius-operator/src/networkmonitor.PodNetworkStats]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·8,*[]mogenius-operator/src/networkmonitor.PodNetworkStats]
 *     properties:
 *       data:
 *         elementType:
 *           structRef: mogenius-operator/src/networkmonitor.PodNetworkStats
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·8,*[]mogenius-operator/src/networkmonitor.PodNetworkStats]
 *   type: struct
 * ```
 *
 */
export type STATS_TRAFFIC_ALL_FOR_CONTROLLER_RESPONSE = STATS_TRAFFIC_ALL_FOR_CONTROLLER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST8_MOGENIUS_OPERATOR_SRC_NETWORKMONITOR_PODNETWORKSTATS;
 ...
 *       value:
 *         type: float
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·9,[]mogenius-operator/src/core.GenericChartEntry]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·9,[]mogenius-operator/src/core.GenericChartEntry]
 *     properties:
 *       data:
 *         elementType:
 *           structRef: mogenius-operator/src/core.GenericChartEntry
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·9,[]mogenius-operator/src/core.GenericChartEntry]
 *   type: struct
 * ```
 *
 */
export type STATS_WORKSPACE_CPU_UTILIZATION_RESPONSE = STATS_WORKSPACE_CPU_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST9_MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY;
 ...
 *
 */
export type STATS_WORKSPACE_MEMORY_UTILIZATION_RESPONSE = STATS_WORKSPACE_MEMORY_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST9_MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY;
 ...
 *
 */
export type STATS_WORKSPACE_TRAFFIC_UTILIZATION_RESPONSE = STATS_WORKSPACE_TRAFFIC_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST9_MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·36,string]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·36,string]
 *     properties:
 *       data:
 *         type: string
 *       message:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·36,string]
 *   type: struct
 * ```
 *
 */
export type UPDATE_GRANT_RESPONSE = UPDATE_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST36_STRING;
 ...
 *
 */
export type UPDATE_USER_RESPONSE = UPDATE_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST31_STRING;
 ...
 *
 */
export type UPDATE_WORKSPACE_RESPONSE = UPDATE_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST26_STRING;
 ...
 * ```yaml
 * structs:
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·6,*mogenius-operator/src/structs.Job]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·6,*mogenius-operator/src/structs.Job]
 *     properties:
 *       data:
 *         pointer: true
 ...
 *     properties: {}
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·6,*mogenius-operator/src/structs.Job]
 *   type: struct
 * ```
 *
 */
export type UPGRADEK8SMANAGER_RESPONSE = UPGRADEK8SMANAGER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST6_MOGENIUS_OPERATOR_SRC_STRUCTS_JOB;
 ...
 *       reason:
 *         type: string
 *   mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·25,mogenius-operator/src/core.CleanUpResult]:
 *     name: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·25,mogenius-operator/src/core.CleanUpResult]
 *     properties:
 *       data:
 ...
 *         type: string
 * typeInfo:
 *   structRef: mogenius-operator/src/core.Result[mogenius-operator/src/core.Request·25,mogenius-operator/src/core.CleanUpResult]
 *   type: struct
 * ```
 *
 */
export type WORKSPACE_CLEAN_UP_RESPONSE = WORKSPACE_CLEAN_UP_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST25_MOGENIUS_OPERATOR_SRC_CORE_CLEANUPRESULT;
...
export type AIMANAGER_GET_TASKS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST42_MOGENIUS_OPERATOR_SRC_AI_AITASK = {"data": AIMANAGER_GET_TASKS_RESPONSE__MOGENIUS_OPERATOR_SRC_AI_AITASK[],"message": string,"status": string};
...
export type AIMANAGER_INJECT_PROMPT_CONFIG_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST39_MOGENIUS_OPERATOR_SRC_CORE_VOID = {"data": AIMANAGER_INJECT_PROMPT_CONFIG_RESPONSE__ANON_STRUCT_1|undefined,"message": string,"status": string};
...
export type AIMANAGER_LATEST_TASK_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST45_MOGENIUS_OPERATOR_SRC_AI_AITASKLATEST = {"data": AIMANAGER_LATEST_TASK_RESPONSE__MOGENIUS_OPERATOR_SRC_AI_AITASKLATEST|undefined,"message": string,"status": string};
...
export type AIMANAGER_READ_TASK_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST43_MOGENIUS_OPERATOR_SRC_CORE_VOID = {"data": AIMANAGER_READ_TASK_RESPONSE__ANON_STRUCT_1|undefined,"message": string,"status": string};
...
export type AIMANAGER_STATUS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST41_MOGENIUS_OPERATOR_SRC_AI_AIMANAGERSTATUS = {"data": AIMANAGER_STATUS_RESPONSE__MOGENIUS_OPERATOR_SRC_AI_AIMANAGERSTATUS,"message": string,"status": string};
export type AIMANAGER_UPDATE_FILTER_STATES_REQUEST__MOGENIUS_OPERATOR_SRC_AI_AIFILTER = {"contains": Record<string, string>,"description": string,"excludes": Record<string, string>,"for": number|undefined,"id": string,"isActive": boolean,"kind": string,"name": string,"prompt": string};
export type AIMANAGER_UPDATE_FILTER_STATES_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_UPDATEFILTERSREQUEST = {"filters": AIMANAGER_UPDATE_FILTER_STATES_REQUEST__MOGENIUS_OPERATOR_SRC_AI_AIFILTER[],"userFilters": AIMANAGER_UPDATE_FILTER_STATES_REQUEST__MOGENIUS_OPERATOR_SRC_AI_AIFILTER[]};
export type AIMANAGER_UPDATE_FILTER_STATES_RESPONSE__ANON_STRUCT_1 = {};
export type AIMANAGER_UPDATE_FILTER_STATES_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_UPDATEFILTERSREQUEST40_MOGENIUS_OPERATOR_SRC_CORE_VOID = {"data": AIMANAGER_UPDATE_FILTER_STATES_RESPONSE__ANON_STRUCT_1|undefined,"message": string,"status": string};
...
export type AIMANAGER_UPDATE_TASK_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST44_MOGENIUS_OPERATOR_SRC_CORE_VOID = {"data": AIMANAGER_UPDATE_TASK_RESPONSE__ANON_STRUCT_1|undefined,"message": string,"status": string};
export type ALERTMANAGER_ALERTS_CREATE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_SENDALERTREQUEST = {"annotations": Record<string, string>,"endsAt": ALERTMANAGER_ALERTS_CREATE_REQUEST__TIME_TIME,"generatorURL": string,"labels": Record<string, string>,"startsAt": ALERTMANAGER_ALERTS_CREATE_REQUEST__TIME_TIME};
export type ALERTMANAGER_ALERTS_CREATE_REQUEST__TIME_TIME = {};
export type ALERTMANAGER_ALERTS_CREATE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_SENDALERTREQUEST_STRING = {"data": string,"message": string,"status": string};
export type ALERTMANAGER_ALERTS_LIST_REQUEST__ANON_STRUCT_0 = {};
export type ALERTMANAGER_ALERTS_LIST_RESPONSE__ANON_STRUCT_3 = {"Name": string};
export type ALERTMANAGER_ALERTS_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_ALERT = {"annotations": Record<string, string>,"endsAt": ALERTMANAGER_ALERTS_LIST_RESPONSE__TIME_TIME,"fingerprint": string,"generatorURL": string,"labels": Record<string, string>,"receivers": ALERTMANAGER_ALERTS_LIST_RESPONSE__ANON_STRUCT_3[],"startsAt": ALERTMANAGER_ALERTS_LIST_RESPONSE__TIME_TIME,"status": ALERTMANAGER_ALERTS_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_ALERTSTATUS,"updatedAt": ALERTMANAGER_ALERTS_LIST_RESPONSE__TIME_TIME};
export type ALERTMANAGER_ALERTS_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_ALERTSTATUS = {"inhibitedBy": string[],"silencedBy": string[],"state": string};
export type ALERTMANAGER_ALERTS_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_ALERT = {"data": ALERTMANAGER_ALERTS_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_ALERT[],"message": string,"status": string};
export type ALERTMANAGER_ALERTS_LIST_RESPONSE__TIME_TIME = {};
export type ALERTMANAGER_SILENCES_CREATE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_ALERTMATCHER = {"isEqual": boolean,"isRegex": boolean,"name": string,"value": string};
export type ALERTMANAGER_SILENCES_CREATE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_SILENCEREQUEST = {"comment": string,"createdBy": string,"endsAt": ALERTMANAGER_SILENCES_CREATE_REQUEST__TIME_TIME,"matchers": ALERTMANAGER_SILENCES_CREATE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_ALERTMATCHER[],"startsAt": ALERTMANAGER_SILENCES_CREATE_REQUEST__TIME_TIME};
export type ALERTMANAGER_SILENCES_CREATE_REQUEST__TIME_TIME = {};
export type ALERTMANAGER_SILENCES_CREATE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_SILENCEREQUEST_STRING = {"data": string,"message": string,"status": string};
export type ALERTMANAGER_SILENCES_DELETE_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST = {"silenceId": string};
export type ALERTMANAGER_SILENCES_DELETE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST17_STRING = {"data": string,"message": string,"status": string};
export type ALERTMANAGER_SILENCES_LIST_REQUEST__ANON_STRUCT_0 = {};
export type ALERTMANAGER_SILENCES_LIST_RESPONSE__ANON_STRUCT_4 = {"state": string};
export type ALERTMANAGER_SILENCES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_ALERTMATCHER = {"isEqual": boolean,"isRegex": boolean,"name": string,"value": string};
export type ALERTMANAGER_SILENCES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_SILENCE = {"data": ALERTMANAGER_SILENCES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_SILENCE[],"message": string,"status": string};
export type ALERTMANAGER_SILENCES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_SILENCE = {"comment": string,"createdBy": string,"endsAt": ALERTMANAGER_SILENCES_LIST_RESPONSE__TIME_TIME,"id": string,"matchers": ALERTMANAGER_SILENCES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_ALERTMATCHER[],"startsAt": ALERTMANAGER_SILENCES_LIST_RESPONSE__TIME_TIME,"status": ALERTMANAGER_SILENCES_LIST_RESPONSE__ANON_STRUCT_4,"updatedAt": ALERTMANAGER_SILENCES_LIST_RESPONSE__TIME_TIME};
export type ALERTMANAGER_SILENCES_LIST_RESPONSE__TIME_TIME = {};
export type AUDIT_LOG_LIST_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST = {"limit": number,"offset": number,"search": string,"workspaceName": string};
...
export type AUDIT_LOG_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST46_MOGENIUS_OPERATOR_SRC_CORE_RESPONSE47 = {"data": AUDIT_LOG_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESPONSE,"message": string,"status": string};
...
export type CLUSTER_DASHBOARD_STATS_REQUEST__ANON_STRUCT_0 = {};
export type CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_CLUSTERDASHBOARDSTATS = {"cpuHistory": CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY[],"workspaceMetrics": CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_WORKSPACEDASHBOARDMETRICS[]};
export type CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY = {"pods": Record<string, number>,"time": CLUSTER_DASHBOARD_STATS_RESPONSE__TIME_TIME,"value": number};
export type CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_CLUSTERDASHBOARDSTATS = {"data": CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_CLUSTERDASHBOARDSTATS,"message": string,"status": string};
export type CLUSTER_DASHBOARD_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_WORKSPACEDASHBOARDMETRICS = {"cpuMillicores": number,"memoryMb": number,"name": string,"podCount": number};
export type CLUSTER_DASHBOARD_STATS_RESPONSE__TIME_TIME = {};
...
export type CLUSTER_MACHINE_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST18_MOGENIUS_OPERATOR_SRC_STRUCTS_MACHINESTATS = {"data": CLUSTER_MACHINE_STATS_RESPONSE__MOGENIUS_OPERATOR_SRC_STRUCTS_MACHINESTATS[],"message": string,"status": string};
...
export type CLUSTER_RESOURCE_INFO_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_CLUSTERRESOURCEINFO5 = {"data": CLUSTER_RESOURCE_INFO_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_CLUSTERRESOURCEINFO,"message": string,"status": string};
...
export type CREATE_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST34_STRING = {"data": string,"message": string,"status": string};
...
export type CREATE_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST29_STRING = {"data": string,"message": string,"status": string};
...
export type CREATE_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST23_STRING = {"data": string,"message": string,"status": string};
export type DELETE_GRANT_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST = {"name": string};
export type DELETE_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST37_STRING = {"data": string,"message": string,"status": string};
export type DELETE_USER_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST = {"name": string};
export type DELETE_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST32_STRING = {"data": string,"message": string,"status": string};
...
export type DELETE_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST27_STRING = {"data": string,"message": string,"status": string};
...
export type DESCRIBE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_RESPONSE4 = {"data": DESCRIBE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESPONSE,"message": string,"status": string};
...
export type FILES_CHMOD_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST14_BOOL = {"data": boolean,"message": string,"status": string};
...
export type FILES_CHOWN_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST13_BOOL = {"data": boolean,"message": string,"status": string};
...
export type FILES_CREATE_FOLDER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST11_BOOL = {"data": boolean,"message": string,"status": string};
...
export type FILES_DELETE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST15_BOOL = {"data": boolean,"message": string,"status": string};
...
export type FILES_DOWNLOAD_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST16_MOGENIUS_OPERATOR_SRC_SERVICES_FILESDOWNLOADRESPONSE = {"data": FILES_DOWNLOAD_RESPONSE__MOGENIUS_OPERATOR_SRC_SERVICES_FILESDOWNLOADRESPONSE,"message": string,"status": string};
...
export type FILES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST10_MOGENIUS_OPERATOR_SRC_DTOS_PERSISTENTFILEDTO = {"data": FILES_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_DTOS_PERSISTENTFILEDTO[],"message": string,"status": string};
...
export type FILES_RENAME_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST12_BOOL = {"data": boolean,"message": string,"status": string};
...
export type GET_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST35_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_GRANT = {"data": GET_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_GRANT|undefined,"message": string,"status": string};
...
export type GET_GRANTS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST33_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_GRANT = {"data": GET_GRANTS_RESPONSE__MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_GRANT[],"message": string,"status": string};
...
export type GET_NODES_METRICS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_VOID_MOGENIUS_OPERATOR_SRC_CORE_RESPONSE50 = {"data": GET_NODES_METRICS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESPONSE,"message": string,"status": string};
...
export type GET_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST30_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_USER = {"data": GET_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_USER|undefined,"message": string,"status": string};
...
export type GET_USERS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST28_MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_USER = {"data": GET_USERS_RESPONSE__MOGENIUS_OPERATOR_SRC_CRDS_V1ALPHA1_USER[],"message": string,"status": string};
...
export type GET_WORKLOAD_LIST_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST19_K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTUREDLIST = {"data": GET_WORKLOAD_LIST_RESPONSE__K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTUREDLIST,"message": string,"status": string};
...
export type GET_WORKLOAD_POD_EVENTS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_PODEVENTSREQUEST21_MOGENIUS_OPERATOR_SRC_CORE_PODEVENT22 = {"data": GET_WORKLOAD_POD_EVENTS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_PODEVENT[],"message": string,"status": string};
...
export type GET_WORKLOAD_POD_LOGS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_PODLOGSREQUEST20_STRING = {"data": string,"message": string,"status": string};
...
export type GET_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST24_MOGENIUS_OPERATOR_SRC_CORE_GETWORKSPACERESULT = {"data": GET_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_GETWORKSPACERESULT|undefined,"message": string,"status": string};
...
export type GET_WORKSPACE_WORKLOADS_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST38_K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTURED = {"data": GET_WORKSPACE_WORKLOADS_RESPONSE__K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTURED[],"message": string,"status": string};
...
export type SEALED_SECRET_CREATE_FROM_EXISTING_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST48_K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTURED = {"data": SEALED_SECRET_CREATE_FROM_EXISTING_RESPONSE__K8S_IO_APIMACHINERY_PKG_APIS_META_V1_UNSTRUCTURED_UNSTRUCTURED|undefined,"message": string,"status": string};
...
export type STATS_WORKSPACE_CPU_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST9_MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY = {"data": STATS_WORKSPACE_CPU_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY[],"message": string,"status": string};
...
export type STATS_WORKSPACE_MEMORY_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST9_MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY = {"data": STATS_WORKSPACE_MEMORY_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY[],"message": string,"status": string};
...
export type STATS_WORKSPACE_TRAFFIC_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST9_MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY = {"data": STATS_WORKSPACE_TRAFFIC_UTILIZATION_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_GENERICCHARTENTRY[],"message": string,"status": string};
...
export type UPDATE_GRANT_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST36_STRING = {"data": string,"message": string,"status": string};
...
export type UPDATE_USER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST31_STRING = {"data": string,"message": string,"status": string};
...
export type UPDATE_WORKSPACE_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST26_STRING = {"data": string,"message": string,"status": string};
export type UPGRADEK8SMANAGER_REQUEST__MOGENIUS_OPERATOR_SRC_CORE_REQUEST = {"command": string};
export type UPGRADEK8SMANAGER_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST6_MOGENIUS_OPERATOR_SRC_STRUCTS_JOB = {"data": UPGRADEK8SMANAGER_RESPONSE__MOGENIUS_OPERATOR_SRC_STRUCTS_JOB|undefined,"message": string,"status": string};
...
export type WORKSPACE_CLEAN_UP_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_RESULTMOGENIUS_OPERATOR_SRC_CORE_REQUEST25_MOGENIUS_OPERATOR_SRC_CORE_CLEANUPRESULT = {"data": WORKSPACE_CLEAN_UP_RESPONSE__MOGENIUS_OPERATOR_SRC_CORE_CLEANUPRESULT,"message": string,"status": string};
...
export interface IPatternConfig {
  ...
  [Pattern.AIMANAGER_LATEST_TASK]: {
    Request: AIMANAGER_LATEST_TASK_REQUEST;
    Response: AIMANAGER_LATEST_TASK_RESPONSE;
  };
  [Pattern.AIMANAGER_READ_TASK]: {
    Request: AIMANAGER_READ_TASK_REQUEST;
    Response: AIMANAGER_READ_TASK_RESPONSE;
  };
  [Pattern.AIMANAGER_RESET_DAILY_TOKEN_LIMIT]: {
    Request: AIMANAGER_RESET_DAILY_TOKEN_LIMIT_REQUEST;
    Response: AIMANAGER_RESET_DAILY_TOKEN_LIMIT_RESPONSE;
  };
  [Pattern.AIMANAGER_STATUS]: {
    Request: AIMANAGER_STATUS_REQUEST;
    Response: AIMANAGER_STATUS_RESPONSE;
  };
  [Pattern.AIMANAGER_UPDATE_FILTER_STATES]: {
    Request: AIMANAGER_UPDATE_FILTER_STATES_REQUEST;
    Response: AIMANAGER_UPDATE_FILTER_STATES_RESPONSE;
  };
  [Pattern.AIMANAGER_UPDATE_TASK]: {
    Request: AIMANAGER_UPDATE_TASK_REQUEST;
    Response: AIMANAGER_UPDATE_TASK_RESPONSE;
  };
  [Pattern.ALERTMANAGER_ALERTS_CREATE]: {
    Request: ALERTMANAGER_ALERTS_CREATE_REQUEST;
    Response: ALERTMANAGER_ALERTS_CREATE_RESPONSE;
  };
  [Pattern.ALERTMANAGER_ALERTS_LIST]: {
    Request: ALERTMANAGER_ALERTS_LIST_REQUEST;
    Response: ALERTMANAGER_ALERTS_LIST_RESPONSE;
  };
  [Pattern.ALERTMANAGER_SILENCES_CREATE]: {
    Request: ALERTMANAGER_SILENCES_CREATE_REQUEST;
    Response: ALERTMANAGER_SILENCES_CREATE_RESPONSE;
  };
  [Pattern.ALERTMANAGER_SILENCES_DELETE]: {
    Request: ALERTMANAGER_SILENCES_DELETE_REQUEST;
    Response: ALERTMANAGER_SILENCES_DELETE_RESPONSE;
  };
  [Pattern.ALERTMANAGER_SILENCES_LIST]: {
    Request: ALERTMANAGER_SILENCES_LIST_REQUEST;
    Response: ALERTMANAGER_SILENCES_LIST_RESPONSE;
  };
  ...
  [Pattern.CLUSTER_DASHBOARD_STATS]: {
    Request: CLUSTER_DASHBOARD_STATS_REQUEST;
    Response: CLUSTER_DASHBOARD_STATS_RESPONSE;
  };
  ...
  [Pattern.LIVE_STREAM_AI_MANAGER_CHAT_REQUEST]: {
    Request: LIVE_STREAM_AI_MANAGER_CHAT_REQUEST_REQUEST;
    Response: LIVE_STREAM_AI_MANAGER_CHAT_REQUEST_RESPONSE;
  };
