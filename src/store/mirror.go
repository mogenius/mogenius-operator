...
func ListNetworkPolicies(namespace string) ([]networkingV1.NetworkPolicy, error) {
	...
	policies, err := redisstore.GetObjectsByPrefix[networkingV1.NetworkPolicy](redisStore, redisstore.ORDER_NONE, REDIS_KEY_PREFIX, resource.Group, "NetworkPolicy", namespace)
	if err != nil {
		return result, err
	}
...
func ListDeployments(namespace string) ([]appsV1.Deployment, error) {
	...
	deployments, err := redisstore.GetObjectsByPrefix[appsV1.Deployment](redisStore, redisstore.ORDER_NONE, REDIS_KEY_PREFIX, resource.Group, "Deployment", namespace)
	if err != nil {
		return result, err
	}
...
func ListStatefulSets(namespace string) ([]appsV1.StatefulSet, error) {
	...
	statefulsets, err := redisstore.GetObjectsByPrefix[appsV1.StatefulSet](redisStore, redisstore.ORDER_NONE, REDIS_KEY_PREFIX, resource.Group, "StatefulSet", namespace)
	if err != nil {
		return result, err
	}
...
func ListEvents(namespace string) ([]coreV1.Event, error) {
	...
	events, err := redisstore.GetObjectsByPrefix[coreV1.Event](redisStore, redisstore.ORDER_DESC, REDIS_KEY_PREFIX, "Event", namespace)
	if err != nil {
		return result, err
	}
...
func ListAllNamespaces() ([]coreV1.Namespace, error) {
	...
	namespaces, err := redisstore.GetObjectsByPrefix[coreV1.Namespace](redisStore, redisstore.ORDER_NONE, REDIS_KEY_PREFIX, resource.Group, "Namespace")
	if err != nil {
		return result, err
	}
...
func GetNamespace(name string) *coreV1.Namespace {
	...
	namespace, _ := redisstore.GetObjectForKey[coreV1.Namespace](redisStore, REDIS_KEY_PREFIX, resource.Group, resource.Kind, name)
	return namespace
}
...
func GetResourceByKindAndNamespace(groupVersion string, kind string, namespace string) []unstructured.Unstructured {
	...
	storeResults, err := redisstore.GetObjectsByPrefix[unstructured.Unstructured](redisStore, redisstore.ORDER_NONE, REDIS_KEY_PREFIX, groupVersion, kind, namespace)
	if err != nil {
		return results
	}
